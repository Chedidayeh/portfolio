...
export function Resume() {
            ...
            content: (
                <div className="flex flex-col gap-4 sm:gap-[30px]">
                    <div>
                        ...
                        <span className="text-blue-500 my-2 sm:my-[10px] font-semibold block">2020 - 2021</span>
                    ...
                    <div>
                        ...
                        <span className="text-blue-500 my-2 sm:my-[10px] font-semibold block">2021 - 2023</span>
                        <p className="mb-4 sm:mb-8 text-xs sm:text-sm md:text-base font-semibold text-neutral-200">
                    ...
                    <div>
                        ...
                        <span className="text-blue-500 my-2 sm:my-[10px] font-semibold block">2023 - 2026</span>
                        <p className="mb-4 sm:mb-8 text-xs sm:text-sm md:text-base font-semibold text-neutral-200">
            ...
            content: (
                <div className="flex flex-col gap-4 sm:gap-[30px]">
                    <div>
                        ...
                        <span className="text-blue-500 my-2 sm:my-[10px] font-semibold block">August 2024 - Today</span>
                        <p className="mb-4 sm:mb-8 text-xs sm:text-sm md:text-base font-semibold text-neutral-200">
    ...
    return (
        <div id="education" className="relative w-full overflow-clip px-4 sm:px-6 md:px-8 lg:px-16 xl:px-52">
            <Timeline data={data} />
        </div>
    );
}
